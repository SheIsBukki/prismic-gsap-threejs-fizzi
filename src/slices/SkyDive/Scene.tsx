...
export default function Scene({ sentence, flavour }: SkyDiveProps) {
  ...
  useGSAP(() => {
    ...
    scrollTl
      ...
      .to(
        ...
        0, // Position parameter of 0 so that everything starts at the beginning
      )
      .to(canRef.current.position, {
        ...getXYPositions(4),
        duration: 0.5,
  ...
  return (
    <group ref={groupRef}>
      {/*We put the rotation attribute here instead of on the FloatingCan to rotate the can straight up because we want the FloatingCan to still move on its axis and not wobble around funny. So we put it in a container and have the container be the thing that is rotating*/}
